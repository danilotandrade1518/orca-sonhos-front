  ...
  render: () => ({
    template: `
      <div style="display: flex; flex-direction: column; gap: 16px;">
        <div>
          <h4>Small</h4>
          <os-money-display value="1250.50" size="small"></os-money-display>
        </div>
        
        <div>
          <h4>Medium</h4>
          <os-money-display value="1250.50" size="medium"></os-money-display>
        </div>
        
        <div>
          <h4>Large</h4>
          <os-money-display value="1250.50" size="large"></os-money-display>
        </div>
      </div>
    `,
  }),
...
export const Interactive: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Exibição de valor monetário interativa com controles para testar todas as propriedades.',
      },
    },
  },
};
