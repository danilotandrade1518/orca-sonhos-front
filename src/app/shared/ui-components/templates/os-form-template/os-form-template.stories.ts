  ...
  actions: [
    {
      ...
      icon: 'save',
      ariaLabel: 'Salvar rascunho do formulário',
    },
    {
      label: 'Visualizar',
      ...
      size: 'medium' as const,
      icon: 'visibility',
      ariaLabel: 'Visualizar prévia do formulário',
    },
  ],
};
...
export const PersonaOptimized: Story = {
  render: () => ({
    template: `
      <div style="display: flex; flex-direction: column; gap: 32px;">
        <div>
          <h4>Ana - Organizadora Familiar</h4>
          <os-form-template
            [config]="anaConfig"
            [showProgress]="true"
          >
            <div style="padding: 20px;">
              <h3>Configuração Familiar</h3>
              <p>Formulário otimizado para Ana com foco em compartilhamento familiar.</p>
            </div>
          </os-form-template>
        </div>

        <div>
          <h4>Carlos - Jovem Planejador</h4>
          <os-form-template
            [config]="carlosConfig"
            [showProgress]="true"
          >
            <div style="padding: 20px;">
              <h3>Primeira Meta</h3>
              <p>Formulário simplificado para Carlos aprender sobre planejamento financeiro.</p>
            </div>
          </os-form-template>
        </div>

        <div>
          <h4>Roberto & Maria - Casal Experiente</h4>
          <os-form-template
            [config]="robertoMariaConfig"
            [showProgress]="true"
          >
            <div style="padding: 20px;">
              <h3>Planejamento Familiar Avançado</h3>
              <p>Formulário detalhado para Roberto e Maria gerenciarem múltiplas metas.</p>
            </div>
          </os-form-template>
        </div>

        <div>
          <h4>Júlia - Empreendedora Iniciante</h4>
          <os-form-template
            [config]="juliaConfig"
            [showProgress]="true"
          >
            <div style="padding: 20px;">
              ...
              <p>Formulário balanceado para Júlia separar finanças pessoais e profissionais.</p>
            </div>
          </os-form-template>
        </div>
      </div>
    ...
    props: {
      anaConfig: {
        ...
        subtitle: 'Configure as informações da sua família',
        showBackButton: true,
        showSaveButton: true,
        showCancelButton: true,
        saveButtonText: 'Salvar Família',
        showProgress: true,
        progressValue: 40,
        persona: 'ana',
        actions: [
          {
            ...
            size: 'medium',
            icon: 'person-add',
            ariaLabel: 'Adicionar novo membro da família',
          },
        ],
      },
      carlosConfig: {
        title: 'Minha Primeira Meta',
        subtitle: 'Vamos criar sua primeira meta financeira',
        showBackButton: true,
        showSaveButton: true,
        showCancelButton: true,
        saveButtonText: 'Criar Meta',
        showProgress: true,
        progressValue: 25,
        persona: 'carlos',
        actions: [
          {
            ...
            size: 'medium',
            icon: 'help',
            ariaLabel: 'Obter ajuda para criar sua primeira meta',
          },
        ],
      },
      robertoMariaConfig: {
        title: 'Planejamento Familiar',
        subtitle: 'Gerencie múltiplas metas e objetivos familiares',
        showBackButton: true,
        showSaveButton: true,
        showCancelButton: true,
        saveButtonText: 'Salvar Planejamento',
        showProgress: true,
        progressValue: 70,
        persona: 'roberto-maria',
        actions: [
          {
            label: 'Relatório',
            variant: 'secondary',
            size: 'medium',
            icon: 'assessment',
            ariaLabel: 'Gerar relatório do planejamento',
          },
          {
            label: 'Projeção',
            variant: 'tertiary',
            size: 'medium',
            icon: 'trending-up',
            ariaLabel: 'Ver projeções futuras',
          },
        ],
      },
      juliaConfig: {
        title: 'Dados do Negócio',
        subtitle: 'Configure as informações da sua empresa',
        showBackButton: true,
        showSaveButton: true,
        showCancelButton: true,
        saveButtonText: 'Salvar Negócio',
        showProgress: true,
        progressValue: 55,
        persona: 'julia',
        actions: [
          {
            ...
            ariaLabel: 'Configurar separação pessoa física e jurídica',
          },
        ],
      },
    },
  ...
  parameters: {
    docs: {
      description: {
        story: 'Templates de formulário otimizados para cada persona do OrçaSonhos.',
      },
    },
  },
};
