...
template.innerHTML = `
  <style>
    ...
    .date { color: var(--os-color-text-muted); font-size: var(--os-font-size-sm); }
...
export class OsTransactionItem extends HTMLElement {
  constructor() {
    super();
...
customElements.define('os-transaction-item', OsTransactionItem);
